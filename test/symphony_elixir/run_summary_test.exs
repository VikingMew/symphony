defmodule SymphonyElixir.RunSummaryTest do
  ...
  test "derives compact run summary from useful timeline rows" do
    history = [
      ...
      %{source: :linear, event: "linear.state_transition", label: "Linear", detail: "In Progress -> Ready to Merge", severity: :info, low_signal: false, metadata: %{}},
    ...
    assert summary.linear_updates == ["In Progress -> Ready to Merge"]
