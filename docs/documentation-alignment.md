...
| Proposed external execution runtime | `docs/execution-runtime-design.md` | The proposed production worker owns checkout, Codex, hooks, project toolchains, validation, handoff, caches, and artifacts under one Panel-issued task lease. PostgreSQL remains the lifecycle authority. This future contract does not describe current runtime behavior. |
