...
| Boundary/test refactors | `CODE_STRUCTURE.md`, `AGENTS.md`, exec plans | 105-157, completed 162-172, active 176-182 | Boundary extraction and test-split work should update module maps and contributor guidance when ownership changes. Residual test-harness thinning is now owned by active 176-182 rather than completed 162-172. |
