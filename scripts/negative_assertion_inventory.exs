...
classify = fn macro, source ->
  cond do
    macro == "refute_receive" -> {"timing", "retain", "ExUnit mailbox timeout contract"}
    ...
    macro == "flunk" -> {"control-flow", "rewrite-match", "explicit success shape"}
    true -> {"implementation-detail", "review-delete-or-positive", "nearest owning contract"}
  end
end
