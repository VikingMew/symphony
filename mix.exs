    ...
    [
      %{
        ...
        exit_slices: %{
          ...
          SymphonyElixir.PRReview.Queue => "extract review dispatch and reconciliation decisions behind injected adapters before counting the GenServer shell",
          SymphonyElixir.PRReview.Handoff => "count after the recoverable handoff boundary accepts an injected persistence adapter",
          SymphonyElixir.PRReview.Delivery => "count after Linear delivery and persistence writes are exposed through injected adapters",
        ...
        modules: [
          ...
          SymphonyElixir.PRReview.Handoff,
          SymphonyElixir.PRReview.Delivery,
      ...
      %{
        ...
        exit_slices: %{
          ...
          SymphonyElixir.PRReview.Store => "count when durable review claim and recovery transitions have a PostgreSQL integration target",
          ...
          SymphonyElixir.Persistence.ReviewJob => "count with schema changeset tests when the review queue has a PostgreSQL integration target",
